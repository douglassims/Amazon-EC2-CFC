<cfcomponent output="false">
	...
	<cffunction name="init" output="false" returntype="EC2">
				...
				<cfloop index="Local.j" from="1" to="#ArrayLen(Local.ipPermissions)#">
					...
					<cfif IsDefined("Local.currentIpPermissions.ipRanges.item")>
						...
						<cfloop index="Local.m" from="1" to="#ArrayLen(Local.ipRanges)#">
							<cfset Local.response[Local.i].ipPermissions[Local.j].groups[Local.k] = Local.ipRanges[Local.m].cidrIp.XmlText/>
						</cfloop>
					</cfif>
				</cfloop>
			</cfloop>
